...
const LobbySection: React.FC<LobbySectionProps> = function ({
	...
	const [selectedTab, setTab] = useState<LobbyTab>(inLobby && !gameState?.isHost ? 'current' : 'mine');
	...
	return (
		<>
			...
			>
				...
				{!lite && <Tab value="mine" label={t('settings.lobbysettings.tab_mine')} sx={{ minHeight: 36, py: 0 }} />}
			</Tabs>
